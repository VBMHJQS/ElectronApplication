...
angular.module('app')
  ...
  .constant('JQ_CONFIG', {
      ...
      bootstrapTable: [
                          'vendor/jquery/bootstraptable/bootstrap-table.min.css',
                          'vendor/jquery/bootstraptable/bootstrap-table.min.js',
                          'vendor/jquery/bootstraptable/bootstrap-table-zh-CN.min.js'],
